...
excel_file_path = '/home/prajole/inputs/file_b_case4_93.xlsx'  # Update with your actual file path
df = pd.read_excel(excel_file_path)

# Images path
images_folder = '/home/prajole/inputs/MODIFIED_ADS_93/'  # Update with your actual images folder

# Output folder path
output_folder = "/home/prajole/outputs_option_selection/llava_onevision_case_4_93"
...
model = LlavaOnevisionForConditionalGeneration.from_pretrained(model_name, torch_dtype=torch.float16, low_cpu_mem_usage=True, device_map="cuda:0")
...
try:
    ...
    for filename in os.listdir(images_folder):
        ...
        debug_folder = "/home/prajole/debug_images/llava_onevision_case_4_93"
        os.makedirs(debug_folder, exist_ok=True)
        image.save(os.path.join(debug_folder, f"loaded_{filename}"))
        ...
        inputs = prompt.to("cuda:0", torch.float16)
