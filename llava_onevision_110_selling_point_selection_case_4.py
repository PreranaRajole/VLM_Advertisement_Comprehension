...
# Images path
images_folder = '/home/prajole/inputs/MODIFIED_ADS_110/'  # Update with your actual images folder

# Output folder path
output_folder = "/home/prajole/outputs_option_selection/llava_onevision_case_4"
...
model = LlavaOnevisionForConditionalGeneration.from_pretrained(model_name, torch_dtype=torch.float16, low_cpu_mem_usage=True, device_map="cuda:1")
...
try:
    ...
    for filename in os.listdir(images_folder):
        ...
        debug_folder = "/home/prajole/debug_images/llava_onevision_case_4"
